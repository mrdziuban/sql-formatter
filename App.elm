...
type Msg = Input String | Spaces String | Select
...
view model =
  div [ class "container" ]
    [ h1 [ class "my-4" ] [ text "SQL Formatter" ]
    ...
    , div [ class "form-group" ]
      ...
      , textarea [ id "sql-input", class "form-control code", placeholder "Enter SQL...", rows 15, onInput Input ] [ text model.input ]
      ]
    , div [ class "form-group" ]
      [ label [ for "sql-output", class "d-flex h4 mb-3" ] [ text "Output" ]
      , textarea [ id "sql-output", class "form-control code mb-3", rows 28, readonly True, onFocus Select, onClick Select ] [ text model.output ]
      ]
    ]
