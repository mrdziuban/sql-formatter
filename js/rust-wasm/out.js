...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'sql_formatter-98ea18fee26b9ec8.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'sql_formatter-98ea18fee26b9ec8.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'sql_formatter-98ea18fee26b9ec8.asm.js';
...
var ASM_CONSTS = [function($0, $1, $2, $3, $4) { WEBPLATFORM.rs_refs[$0].addEventListener(UTF8ToString($1), function (e) {Runtime.dynCall('viii', $3, [$2, $4, e.target ? WEBPLATFORM.rs_refs.push(e.target) - 1 : -1]);}, false); },
 function($0, $1, $2, $3) { var str = UTF8ToString($0).replace(new RegExp(UTF8ToString($1), UTF8ToString($2)), UTF8ToString($3));return allocate(intArrayFromString(str), 'i8', ALLOC_STACK); },
 function($0, $1, $2) { return new RegExp(UTF8ToString($1), UTF8ToString($2)).test(UTF8ToString($0)); },
 function($0) { WEBPLATFORM.rs_refs[$0] = null; },
 function($0, $1) { WEBPLATFORM.rs_refs[$0][UTF8ToString($1)](); },
 ...
 function($0, $1) { var a = allocate(intArrayFromString(WEBPLATFORM.rs_refs[$0][UTF8ToString($1)]), 'i8', ALLOC_STACK); return a; },
 function($0) { var value = document.querySelector(UTF8ToString($0));if (!value) {return -1;}return WEBPLATFORM.rs_refs.push(value) - 1; },
 function() { window.WEBPLATFORM || (window.WEBPLATFORM = { rs_refs: [] }); }];
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "sql_formatter-98ea18fee26b9ec8.js.mem" : null;




var STATIC_BUMP = 20496;
...
var real__syscall = asm["_syscall"]; asm["_syscall"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__syscall.apply(null, arguments);
};
...
var _syscall = Module["_syscall"] = function() { return Module["asm"]["_syscall"].apply(null, arguments) };
...
//# sourceMappingURL=sql_formatter-98ea18fee26b9ec8.js.map